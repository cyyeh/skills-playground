...
2. **Navigation header** — system name, page list with current page highlighted
3. **Page content area** — where section content goes
4. **Page footer** — previous/next page links, "Generated by System Explorer" note
5. **Shared JavaScript** — scroll animations (IntersectionObserver), localStorage for progress tracking, glossary tooltip handler
...
4. Add at least one interactive element per page
...
**Review checklist:**
1. **Level badges** — Do content sections have inline level badges where appropriate for visual clarity?
