...
HTML skeleton templates for every page type generated by the system-to-course skill. Each template is self-contained (inline CSS/JS) and uses the design tokens from `design-system.md`.
...
<body>
  ...
  <!-- ========================================
       ...
       ======================================== -->
  <section class="quick-start animate-in">
    <h2>Quick Start</h2>
...
<body>
  ...
  <main class="content-area">
    ...
    <!-- SECTION EXAMPLE — Beginner content -->
    ...
    <!-- SECTION EXAMPLE — Intermediate content -->
    <section class="content-section">
      <h2>[SECTION_HEADING]</h2>
      <p>[SECTION_BODY_TEXT]</p>
    ...
    <!-- SECTION EXAMPLE — Advanced content -->
    <section class="content-section">
      <h2>[SECTION_HEADING]</h2>
      <p>[SECTION_BODY_TEXT]</p>
    ...
    <!-- SECTION EXAMPLE — Summary / callouts -->
    <section class="content-section">
      <h2>[SECTION_HEADING]</h2>
